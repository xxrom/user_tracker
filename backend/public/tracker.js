...
var Tracker = /** @class */ (function () {
  function Tracker() {
    ...
    if (
      ((_b =
        (_a = window === null || window === void 0 ? void 0 : window.nc) ===
          null || _a === void 0
          ? void 0
          : _a.q) === null || _b === void 0
        ? void 0
      ...
      var q =
        (_c = window === null || window === void 0 ? void 0 : window.nc) ===
          null || _c === void 0
          ? void 0
          : _c.q;
      q.forEach(function (a) {
        var _a = __spreadArray([], a, true),
          event = _a[0],
          tags = _a.slice(1);
  ...
  Tracker.prototype.track = function (event) {
    ...
    var track = this.prepareObject.apply(
      this,
      __spreadArray([event], tags, false),
    );
